...
if [ "${__bashkit_lib_logging_colors_sourced:=}" != "true" ]; then
    ...
    [ -f "$__lib_logging_colors" ] || fatal_tmp "file not found: $__lib_logging_colors"
...
if [ "${__bashkit_lib_logging_symbols_sourced:=}" != "true" ]; then
    ...
    [ -f "${__lib_logging_symbols}" ] || fatal_tmp "file not found: $__lib_logging_symbols"
...
if [ "${__bashkit_lib_logging_error_messages_sourced:=}" != "true" ]; then
    ...
    [ -f "${__lib_logging_error_messages}" ] || fatal_tmp "file not found: $__lib_logging_error_messages"
